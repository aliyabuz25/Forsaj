          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
            <div className="lg:w-8/12 space-y-20">
              ...
              <div>
                ...
                <div
                  className="text-gray-400 font-bold italic text-2xl uppercase leading-relaxed tracking-wide space-y-4"
              ...
              <div>
                ...
                <div className="bg-[#111] p-12 border-l-4 border-[#FF4D00] shadow-2xl">
                  <div
                    className="text-gray-300 font-bold italic text-xl uppercase tracking-widest leading-loose"
